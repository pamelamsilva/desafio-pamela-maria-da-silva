...
describe("CaixaDaLanchonete", () => {
    ...
    test.each([
        ...
        ["debito", "R$ 15,00", ["queijo,1", "sanduiche,2"]],
        ["credito", "R$ 42,64", ["suco,2", "salgado,4"]],
    ])(
        "compra de múltiplas quantidades em %p deve resultar em %p",
        validaTeste
    );
    ...
    test.each([
        ...
        [
            "com dependencia de código inexistente",
            "dinheiro",
            "Item inválido!",
            ["queijo, 1", "sanduiches,2"],
        ],
    ])(
        "compra %p em %p deve resultar em %p",
        (_, formaDePagamento, resultadoEsperado, itens) =>
